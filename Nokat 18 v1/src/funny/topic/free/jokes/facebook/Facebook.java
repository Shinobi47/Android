...
public class Facebook {
     ...
     */
    public Facebook(String appId,CustomSharePreferences customSharePreferencet, String access, Long ex) {
        if (appId == null) {
        ...
        mAppId = appId;
        this.customSharePreferences= customSharePreferencet;
        this.mAccessToken = access;
        this.mAccessExpires = ex;
    }
...
//        }
	...
	private void startDialogAuth(Activity activity, String[] permissions) {
        ...
        dialog(activity, LOGIN, params, new DialogListener() {
            ...
            public void onComplete(Bundle values) {
                ...
                if (isSessionValid()) {
                    WriteLog.d("Facebook-authorize", "Login Success! access_token="
            ...
            public void onError(DialogError error) {
            	WriteLog.d("Facebook-authorize", "Login failed: " + error);
            ...
            public void onCancel() {
            	WriteLog.d("Facebook-authorize", "Login canceled");
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (error != null) {
                    if (error.equals(SINGLE_SIGN_ON_DISABLED)
                    	...
                    	WriteLog.d("Facebook-authorize", "Hosted auth currently "
                            + "disabled. Retrying dialog auth...");
                    	
                        startDialogAuth(mAuthActivity, mAuthPermissions);
                    } else if (error.equals("access_denied")
                            || error.equals("OAuthAccessDeniedException")) {
                    	WriteLog.d("Facebook-authorize", "Login canceled by user.");
                        mAuthDialogListener.onCancel();
                    } else {
    ...
    public boolean isSessionValid() {
        return (this.mAccessToken != null)&&(this.mAccessToken != "") &&((this.mAccessExpires == 0) || (System.currentTimeMillis() < this.mAccessExpires));
    }
...
//    	mAccessToken = customSharePreferences.getPreferencesString(TOKEN);
...
//    	mAccessExpires = customSharePreferences.getPreferencesLong(EXPIRES);
    ...
    public void setAccessToken(String token) {
        mAccessToken = token;
        customSharePreferences.setSharePreferencesString(TOKEN, token);
    }
    ...
    public void setAccessExpires(long time) {
        mAccessExpires = time;
        customSharePreferences.setSharePreferencesString(EXPIRES, String.valueOf(time));
    }
